        ...
        <header class="main-header">
            ...
            <?php if($days < 7){ ?>
                <div class="alert alert-warning alert-dismissible" role="alert" style="margin-bottom:0px;">
                    ...
                    系统提示:系统有效期剩余<?php echo number_format($days); ?>天，请尽快联系技术服务商
                </div>
            <?php } ?>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs"><?= $manager->user_name; ?></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        ...
                        <a href="#">
                            ...
                            <?php if (Yii::$app->services->agent->isAuperAdmin()){; ?>
                                超级管理员
                            <?php }else{ ?>
                                <?= Yii::$app->services->agent->auth->getRole()->name ?? '游客'?>
                            <?php } ?>
                        </a>
                    </div>
                </div>
