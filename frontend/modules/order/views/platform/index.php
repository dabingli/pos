...
$this->title = '交易信息';
$this->params['breadcrumbs'][] = '平台收益记录';
                            ...
                            <form onsubmit="return false" id="myForm" action="<?php echo Url::toRoute('/agent/rbac/user/index'); ?>" method="get" class="form-horizontal">
                                ...
                                <div class="form-group" style="margin-top:15px">
                                    ...
                                    <div class="col-sm-3">
                                    	...
                                    	<a href="<?php echo Url::toRoute(['/order/platform/index']); ?>" class="btn btn-success">重 置</a>
                                    </div>
                                </div>
...
function exports(){
    ...
    window.location.href = '<?php echo Url::toRoute(['platform/export']); ?>?profit_order='+profit_order+
        '&serialNo='+serialNo+'&created_start='+created_start+'&type='+type+'&entry='+entry+
        '&created_end='+created_end+'&user_code='+user_code
}
