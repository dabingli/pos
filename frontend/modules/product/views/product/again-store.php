    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">重新入库</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['product/again-store-do']); ?>" method="post"
                ...
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span
                            class="text-danger">∗</span>重新入库编号:</label>
                ...
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span
                            class="text-danger">∗</span>重新入库日期:</label>
                    <div class="col-sm-2">
                        <div class='input-group date'>
                            <input placeholder="请输入重新入库日期" value="<?php echo date('Y-m-d',time()); ?>" name="store_time"  type='date' class="form-control" />
                ...
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span
                            class="text-danger">∗</span>重新入库人员:</label>
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input placeholder="请输入重新入库人员" value="" type="text"
                ...
                <div class="form-group">
                    <table class="table table-striped table-bordered bulk_action table-hover">
                        ...
                        <tr id="tr">
                            ...
                            <td><input type="text" class="form-control" readonly name="model[]" required></td>
    ...
    function validate(){
        $("#form").validate({
            ...
            rules: {
                'account': {
                    remote: {
                        url: "<?php echo Url::toRoute('product/refund-do'); ?>",     //后台处理程序
                        type: "post",               //数据发送方式
                        dataType: "json",           //接受数据格式
                        data: {                     //要传递的数据
                            'serial': $("#form input[name='serial']").val() ,
                            'store_time': $("#form input[name='store_time']").val() ,
                            'name': $("#form input[name='name']").val() ,
                            'type': $("#form input[name='type']").val() ,
                            'model': $("#form input[name='model']").val() ,
                            'product_amount': $("#form input[name='product_amount']").val() ,
