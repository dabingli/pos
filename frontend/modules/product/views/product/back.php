    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">回拨</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['product/back-do']); ?>" method="post"
                ...
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span
                            class="text-danger">∗</span>回拨编号:</label>
                ...
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span
                            class="text-danger">∗</span>回拨日期:</label>
                    <div class="col-sm-2">
                        <div class='input-group date'>
                            <input placeholder="请输入退货日期" value="<?php echo date('Y-m-d',time()); ?>" name="back_time"  type='date' class="form-control" />
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-md-4" style="width:45%;">
                                        <input type="text" class="form-control" required min="0" name="product_no_start[]" onblur="searchType(this)"/>
                                    </div>
                                    <div class="col-md-1">
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-md-8" style="width:100%;">
                                        <input type="number" class="form-control" min="0" required name="product_amount[]" readonly>
                                    </div>
                                </div>
                            </td>
                            <td>
...
<script type="text/javascript">
    ...
    function add(e)
    {
        ...
        html += '<td>\n' +
            '                            <div class="form-group">\n' +
            '                                <div class="col-md-4" style="width:45%;">\n' +
            '                                    <input type="text" class="form-control" min="0" required name="product_no_start[]" onblur="searchType(this)" />\n' +
            '                                </div>\n' +
            '                                <div class="col-md-1">\n' +
            '                                    <label class="control-label">至</label>\n' +
            '                                </div>\n' +
