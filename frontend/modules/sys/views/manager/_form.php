    ...
    <div class="col-sm-3">
        <div class="box">
            ...
            <p><a class="btn btn-xs btn-primary" data-toggle="modal" data-target="#avatar-modal"> <i class="fa fa-upload"></i> 头像更改</a></p>
                <p class="profile-username"><?= $model->user_name; ?></p>
            <p>最后登陆IP : <?= $model->login_IP ?></p>
...
<?= HtmlHelper::jsFile('@web/resources/bower_components/bootstrap/dist/js/bootstrap.min.js')?>
    ...
    function imagesAjax(src) {
        ...
        $.ajax({
            ...
            success : function(data) {
                if(data.code == 200) {
                    data = data.data;
                    $('#agentuser-head_portrait').val(data.url);
