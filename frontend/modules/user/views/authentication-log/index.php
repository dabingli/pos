    ...
    <div class="col-sm-12">
        <div class="box">
            <div class="panel-body">
                <form onsubmit="return false" id="myForm" action="<?php echo Url::toRoute('/user/authentication-log/index'); ?>" method="get" class="form-horizontal">
                    <div class="form-group" style="margin-top:15px">
                        <label class="control-label col-sm-1">认证状态</label>
                        <div class="col-sm-2">
                            <?php echo Html::dropDownList('status','',[''=>'全部']+UserIdentityAuditLog::getStatusLabels(),['class'=>'form-control']) ?>
                        </div>
                        ...
                        <label class="control-label col-sm-1">认证时间</label>
                        <div class="col-sm-2">
                            <div class='input-group date'>
                                <input placeholder="请输入认证时间" value="" name="audit_at_start"  type='date' class="form-control" />
                        ...
                        <div class="col-sm-2">
                            <div class='input-group date' id="end">
                                <input placeholder="请输入认证时间" value="" name="audit_at_end"  type='date' class="form-control" />
                                <span class="input-group-addon">
                                               <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                            </div>
                    ...
                    <div class="form-group" style="margin-top:15px">
                        ...
                        <div class="col-sm-3" style="text-align:left;">
                            ...
                            <a href="<?php echo Url::toRoute(['/user/authentication-log/index']); ?>" class="btn btn-success">重 置</a>
                        </div>
