    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['edit-do']); ?>" enctype="multipart/form-data" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input placeholder="请输入图文标题" value="<?php echo $model->title; ?>" type="text" class="form-control required" name="title" aria-required="true">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 text-right control-label"><span class="text-danger">∗</span>图文内容:</label>
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <textarea rows="10" cols="30" placeholder="图文内容" class="form-control required" name="content" ><?php echo $model->content; ?></textarea>
                    </div>
                </div>
