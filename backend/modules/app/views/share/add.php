    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">新增APP分享图片</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['share/add-do']); ?>" enctype="multipart/form-data" method="post"
    ...
    function validate(){
        $("#form").validate({
            ...
            rules: {
                'account': {
                    remote: {
                        url: "<?php echo Url::toRoute('share/add-do'); ?>",     //后台处理程序
                        type: "post",               //数据发送方式
