    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['settings/add-do']); ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input placeholder="请输入APP名称" value="" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input  value=""  placeholder="请输入客服电话" value="" type="text"
    ...
    function validate(){
        $("#form").validate({
            ...
            rules: {
                'account': {
                    remote: {
                        url: "<?php echo Url::toRoute('settings/add-do'); ?>",     //后台处理程序
                        type: "post",               //数据发送方式
