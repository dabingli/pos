    ...
    <div class="modal-content" id="detail_body">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">新增APP广告位</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['advertise/add-do']); ?>" enctype="multipart/form-data" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input placeholder="请输入图片说明" value="" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <input  value=""  placeholder="排序" value="" type="number"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <?php echo Html::dropDownList('status',$status,[''=>'请选择']+$status,['class'=>'form-control required']); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="padding: 0px 10px 0px 0px;">
                        <?php echo Html::dropDownList('type',$type,[''=>'请选择']+$type,['class'=>'form-control required']); ?>
...
<script type="text/javascript">
    function validate(){
        $("#form").validate({
            ...
            rules: {
                'account': {
                    remote: {
                        url: "<?php echo Url::toRoute('advertise/add-do'); ?>",     //后台处理程序
                        type: "post",               //数据发送方式
    ...
    $("#image").fileinput({
        ...
        defaultPreviewContent: '<img src="<?php echo \Yii::$app->request->baseUrl.'/fileinput/img/default_avatar_male.jpg';?>" alt="等级图片">',
