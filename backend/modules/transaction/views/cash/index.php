...
$this->title = '代理商提现记录';
$this->params['breadcrumbs'][] = '代理商提现记录';
            ...
            <div class="panel-body">
                <form id="myForm" onsubmit="return bootstrapTable($(this))" action="" method="get" class="form-horizontal">
                    <div class="form-group" style="margin-top:15px">
                        ...
                        <label class="control-label col-sm-1" for="type">提现类型</label>
                        <div class="col-sm-2">
                            <?php echo html::dropDownList('type','',[''=>'全部']+CashOrder::typeLabels(),['class'=>'form-control']) ?>
                        </div>
                    ...
                    <div class="form-group" style="margin-top:15px">
                        ...
                        <label class="control-label col-sm-1">提现日期</label>
                        <div class="col-sm-2">
                        ...
                        <label class="control-label col-sm-1" for="status">交易状态</label>
                        <div class="col-sm-2">
                            <?php echo html::dropDownList('status','',[''=>'全部']+CashOrder::statusLabels(),['class'=>'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:15px">
                        <label class="control-label col-sm-1" for="agent_name">所属服务商</label>
                        <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    function exports(){
        ...
        window.location.href = '<?php echo Url::toRoute(['cash/export']); ?>?unique_order='+unique_order+'&user_code='+user_code+
            '&type='+type+'&status='+status+'&real_name='+real_name+'&created_at_start='+created_at_start+'&created_at_end='+created_at_end
    }
