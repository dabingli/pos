    ...
    <div class="modal-content">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">充值天数</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['/agent/index/recharge-days-do']); ?>" method="post"
                ...
                <div class="form-group">
                    <label class="col-md-5 control-label"><span
                            class="text-danger">∗</span> 充值天数:</label>
                    <div class="col-md-5">
                        <input placeholder="天数" value="" type="number" class="form-control required" name="days" aria-required="true">
                    </div>
                </div>
