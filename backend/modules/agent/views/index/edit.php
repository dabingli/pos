    ...
    <div class="modal-content">
        ...
        <div class="modal-header text-center">
            ...
            <h4 class="modal-title text-danger" id="ajax-view-label">
                <span id="modalDetailTitle">修改服务商</span>&nbsp;
            </h4>
        </div>

        <div class="modal-body form-horizontal">
            <form id="form" class="form-horizontal"
                  action="<?php echo Url::toRoute(['/agent/index/edit-do']); ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3" style="padding: 0px 10px 0px 0px;">
                        <div class='input-group date'>
                            <input id="contract_date" placeholder="请输入签约日期" value="<?php echo $model->contract_date ?>" name="contract_date"  type='date' class="form-control required" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3" style="padding: 0px 10px 0px 0px;">
                        <?php echo RegionWidget::widget(['name'=>'province_id','region_id'=>$model->province_id,'parent_id'=>null,'options'=>['class'=>'form-control required','onchange'=>'city($(this),"city_id")']]); ?>
                    </div>
                    <label class="col-md-1 text-right control-label"><span
                                class="text-danger">∗</span> 归属市:</label>
                    <div class="col-md-3" style="padding: 0px 10px 0px 0px;">
                        <?php echo RegionWidget::widget(['name'=>'city_id','region_id'=>$model->city_id,'parent_id'=>$model->province_id?$model->province_id:false,'options'=>['class'=>'form-control required','id'=>'city_id','onchange'=>'city($(this),"county_id")']]); ?>

                    </div>
                    <label class="col-md-1 text-right control-label"><span
                                class="text-danger">∗</span> 归属区:</label>
                    <div class="col-md-3" style="padding: 0px 10px 0px 0px;">
                        <?php echo RegionWidget::widget(['name'=>'county_id','region_id'=>$model->county_id,'parent_id'=>$model->city_id?$model->city_id:false,'options'=>['class'=>'form-control required','id'=>'county_id']]); ?>
                    </div>
                </div>
